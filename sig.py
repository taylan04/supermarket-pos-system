    ...
    while True:
        ...
        match opcao:
            case 0:
                ...
                if escolha == 0:
                    gerenciar_fornecedores_produto(produto.id_produto)
            ...
            case 2:
                ...
                print("\nDeseja gerenciar fornecedores de algum produto?")
                print("[0] - Sim")
                print("[1] - Não")
                escolha = entrar_inteiro_zero_permitido("\nOpção: ")
